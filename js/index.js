//quotes arrays
let obiwanQuotes;
let darthvaderQuotes;
let yodaQuotes;
let lukeskywalkerQuotes;
let hansoloQuotes;
let leiaQuotes;
let c3poQuotes;
let emperorQuotes;
...
//função para pegar os elementos html
...
//atribuir as frases a arrays
function setQuotes() {
  
    obiwanQuotes = [ // Obi-Wan Kenobi Quotes
    ...
    darthvaderQuotes = ["I find your lack of faith disturbing. \n-Darth Vader",
    ...
    yodaQuotes = [      "Do. Or do not. There is no try. \n-Yoda",
    ...
    lukeskywalkerQuotes = [      "I'll never turn to the Dark Side. You've failed, your highness. I am a Jedi, like my father before me. \n-Luke Skywalker",
        "If there's a bright center to the universe, you're on the planet that it's farthest from. \n-Luke Skywalker",
        "I'm Luke Skywalker. I'm here to rescue you. \n-Luke Skywalker",
        "The Force is strong in my family. My father has it. I have it. My sister has it. You have that power, too. \n-Luke Skywalker",
        "But I was going into Tosche Station to pick up some power converters! \n-Luke Skywalker"];
      
    hansoloQuotes = ["Chewie...we're home. \n-Han Solo",
    ...
    leiaQuotes = [      "Help me, Obi-Wan Kenobi. You're my only hope. \n-Princess Leia Organa",
    ...
    c3poQuotes = [      "I suggest a new strategy, R2: let the Wookiee win. \n-C-3PO",
        "We seem to be made to suffer. It's our lot in life. \n-C-3PO",
        "Sir, the possibility of successfully navigating an asteroid field is approximately 3,720 to 1. \n-C-3PO",
        "Sir, it's quite possible this asteroid is not entirely stable. \n-C-3PO",
        "Don’t call me a mindless philosopher, you overweight glob of grease! \n-C-3PO"];
      
    emperorQuotes = ["Young fool... Only now, at the end, do you understand... \n-The Emperor",
        "Your feeble skills are no match for the power of the Dark Side. \n-The Emperor",
        "Now, you will pay the price for your lack of vision! \n-The Emperor",
        "I will make it legal. \n-Darth Sidious"];
      
    miscQuotes = ["Many Bothans died to bring us this information. \n-Mon Mothma",
...
//pegar os valores pela api e preencher os contadores(pessoas, naves e planetas)
...
//requisitar os valores em json pela api
function getData(param){
    return fetch(`https://swapi.dev/api/${param}`)
        .then(res => res.json())
}

//carregar as frases na interface
...
//recebe uma frase aleatória dentro dos arrays
